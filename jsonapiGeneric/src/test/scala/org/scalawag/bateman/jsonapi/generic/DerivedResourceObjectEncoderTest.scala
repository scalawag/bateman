...
//import org.scalawag.bateman.json.decoding.PrettySpaces2
...
//        @Relationship parent: ResourceIdentifier
//    )
//
//    object Square {
...
//      encoded shouldBe PartiallyEncoded(bro(b)).rightNec
//    }
//
//    it("should include the A") {
//      val b = B("foo", A("bar", 17))
//      val encoded = ResourceObjectEncoder.encodeResource(b, IncludeSpec.unsafe("a"))
//      encoded shouldBe PartiallyEncoded(bro(b), Inclusions(aro(b.a))).rightNec
//    }
//
...
//      encoded shouldBe InvalidIncludePath("a.c").leftNec
//    }
//
...
//      @Id id: String,
//      @Attribute a: Int,
//      @Relationship b: Option[ResourceIdentifier] = None
//  )
//
//  object A {
