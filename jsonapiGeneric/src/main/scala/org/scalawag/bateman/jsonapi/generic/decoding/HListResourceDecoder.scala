...
import org.scalawag.bateman.jsonapi.generic.decoding.HListResourceDecoderFactory.Output
import shapeless.HList

trait HListResourceDecoder[Out <: HList] {
  def decode(input: Input): JResult[Output[Out]]
}
